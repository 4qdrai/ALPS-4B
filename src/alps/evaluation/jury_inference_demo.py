...
def simulate_jury_demo():
    ...
    # Video A: Real Semantic "Sunny Case" (e.g. people walking predictably)
    video_A = load_video_tensor('data/sample_A.avi', device)
    print(f"  > Video A (Sunny Case) loaded from 'data/sample_A.avi'")
    
    # Video B: Real Semantic "Surprise" (e.g. sudden chaotic action)
