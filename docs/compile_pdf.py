...
def compile_markdown_to_pdf():
    ...
    html_template = html_template.replace(
        "<p><strong>4QDR AI Research Team</strong><br />\n<em>research@4qdr.ai</em><br />\n<a href=\"https://github.com/4qdrai/4B-JEPA\">GitHub Repository</a></p>",
        "<div class='author-box'><strong>4QDR AI Research Team</strong><br/><em>research@4qdr.ai</em><br/><a href='https://github.com/4qdrai/4B-JEPA'>GitHub Repository</a></div>"
    )
